...
- **knowledge_base**（市场知识库）：平台内置以宏观数据为主（CNNIC 互联网统计报告、国家统计局月度指标、gov.cn 数字经济/平台经济政策文件），细分品类/品牌内容需用户自行上传研报或历史资料补充；仅适合需要整体互联网规模、宏观经济指标或数字/平台经济政策趋势作为背景佐证的场景
...
- **knowledge_base 默认不输出**。只有当 brief 的研究目标明确涉及整体互联网规模、宏观经济指标、数字/平台经济政策趋势时才加入；品牌/品类/决策行为/消费者口碑/舆情类研究一律省略该条目，不要为了"补充宏观背景"硬凑一条
...
{{
  ...
  "channel_plan": [
    ...
    {{
      "type": "knowledge_base",
      "available": true,
      "solvable": ["宏观互联网/经济/政策背景参照"],
      "unsolvable": ["细分品类市场数据", "品牌/产品层面的内部信息"],
      "channel_brief": "检索知识库中与[subject]所在宏观行业相关的统计报告和政策文件，作为背景参照..."
    }},
    {{
      "type": "news_media",
      "available": true,
