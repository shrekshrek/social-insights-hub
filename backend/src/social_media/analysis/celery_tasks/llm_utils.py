...
def invoke_llm_with_stats_sync(llm, messages: list, llm_type: str = "chat") -> tuple[Any, Dict[str, Any]]:
...
def invoke_chain_with_stats_sync(chain, input_dict: Dict[str, Any], llm_type: str = "chat") -> tuple[Any, Dict[str, Any]]:
