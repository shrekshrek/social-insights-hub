...
# 跨渠道 Token 使用 + AnalysisJob schemas 迁至 src/jobs/schemas.py（P1, ADR-001）。
# 这里 re-export 以便旧调用方过渡；新代码请直接 `from src.jobs.schemas import ...`。
from src.jobs.schemas import (  # noqa: F401
    AnalysisJobCreate,
