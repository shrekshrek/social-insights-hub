...
> 实验日期:2026-04-20
> 样本:Strategy #18(猎风功能饮料)+ Strategy #7(魔尊素肚世界杯)
...
|---------|--------|-----|--------|
| #18 猎风 | 品类级(多品牌多平台,饮料赛道) | **Path B 大胜** | 跨源 pattern-matching 抓到 Path A 漏的 3 大议题 |
| #7 魔尊素肚 | 品牌聚焦 + 高 IP 泛化(世界杯场景) | **Path A 更 on-topic** | Path B 被 IP 爆款(顶流选手/当红球星)带偏,漏抓品牌核心痛点"麻酱量少" |
...
- 完成状态:`completed`
- Brief 概要:为猎风功能饮料制定 2026 年品牌策略,分析竞品(蛮牛、潮涌特饮、巨兽能量、奔马)格局,目标人群为 18-30 岁蓝领工人、外卖骑手、长途司机、电竞玩家
...
2. 🔥 **蛮牛版本混乱从"假货监管"演变为品类系统性信任侵蚀**(A 完全未提)
...
- **Opp 4:"真能量,不迷惑"透明化运动** — 针对 Tension 2(蛮牛版本混乱)的 ready-to-use campaign 概念,含完整 rationale 和竞品对比
- **Opp 1:蓝领奋斗者的情感能量站** — 基于猎风已有骑手纪录片资产放大,含竞品差异化分析
...
```sql
-- 蛮牛版本混乱(Path B Tension #2,Path A 漏掉)
...
WHERE st.monitor_id=44 AND sp.is_deleted=false
  AND (sp.content ~ '蛮牛.*(版本|假|正版|影身|分不清|海外版|原装)'
    OR sp.title ~ '蛮牛.*(版本|假|正版|影身|分不清|海外版|原装)');
...
|------|-----------|--------|------------|
| 蛮牛版本混乱 | **161 帖** | **340 万** | ❌ 完全未提 |
| 蓝领情感 | **355 帖** | **542 万** | ❌ 完全未提 |
| 心理安慰剂 | 29 帖 | 11 万 | ✅ 捧为 Tension #1 |

**Path A 不仅丢失了语境,还严重扭曲了议题的相对重要性。**

真实规模 30-50 倍的议题被漏掉,被捧上 Tension #1 的反而是小众议题。若猎风据此投放预算,会压在"破除安慰剂质疑"的宣传上,而真正的市场机会在"透明化打法对标蛮牛"和"蓝领情感能量站"——这是会让市场费用打水漂的错判。
...
| 20945 | 阿鉴蛮牛三版本视频 | ✅ 标题"蛮牛影身之术",10.9 万赞 |
| 21079 | 猎风骑手纪录片 | ✅ "猎风携手快象《城市夜行人》",5.9 万赞 |
| 21487 | 潮涌半仙"打工神水" | ✅ 38 万赞 |
| 21500 | 运动饮料 vs 能量饮料科普 | ✅ 4.8 万赞 |
| 21508 | 潮涌瓶盖量米妙用 | ✅ 7.9 万赞,内容一致 |
...
- 阿鉴视频 20945 是 62 万赞的单点爆款(heat 算法把它稀释在 cluster 里)
...
Path B 直接读原始帖,LLM 在自然语境下做 pattern-matching,蛮牛版本讨论形成明显 cluster、蓝领情感主题自然浮现。
...
3. **猎风骑手情感可能被自家纪录片放大**:官方发布的 21079 被猎风引流,不是纯自发 UGC
...
## 11. 补充实验:Strategy #7(魔尊素肚世界杯营销策略)
...
3. 🎯 **"素毛肚/魔芋制品"的"认知健康 vs 酱料不足宣传不符"**(直击魔尊品牌核心痛点)

**Path B 的 4 条 tension**:
1. 魔芋制品社媒 vs 新闻健康认知反差(跨源洞察,有价值)
2. 观赛社交需求 vs 食用不便痛点(有价值)
3. ⚠️ "魔尊"IP 泛化联想(顶流选手 被羞辱、当红球星反派)——**偏离 subject**
4. ⚠️ 品牌赞助舆论风险(某车企赞助国足)——**与魔尊关联弱**

### 11.4 定量验证

| 议题 | 讨论规模 | Path A | Path B |
|------|--------|--------|--------|
| 麻酱量少/宣传不符(魔尊核心痛点) | **328 帖,463 万赞** | ✅ Tension #3 | ❌ 样本里有 16 帖但未提升为 tension |
| 顶流选手/当红球星(IP 泛化) | 9 帖,218 万赞(集中于少数爆款) | 未提 | ⚠️ Tension #3 |
| 某车企赞助国足 | 35 帖,209 万赞 | 未提 | ⚠️ Tension #4 |
...
- 本次实验涉及 Strategy ID:18(猎风)、7(魔尊素肚)
