...
import type { AnalysisStatus } from "~~/layers/jobs/types";

// 跨渠道类型从 jobs layer 统一导出
export type {
  CallDetail,
  TokenUsageSummary,
  TokenUsageStats,
...
export type PostAnalysisListResponse =
  PaginatedResponse<PostAnalysisWithPostInfo>;
