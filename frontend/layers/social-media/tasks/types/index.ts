...
export interface SocialQuickTaskCreate {
  platform_ids: number[];
...
export interface SocialMonitorUpdate {
  name?: string;
  description?: string;
  start_date?: string;
  end_date?: string;
...
export interface MonitorCreateResponse {
  ...
  created_tasks: SocialTaskWithRelations[];
}
...
export interface SocialTaskWithRelations extends SocialTask {
